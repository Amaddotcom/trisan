...
cl = LINETCR.LINE()
#cl.login()
cl.login(token='Et9Px2hF1HTs3tScDuQ7.szOnB/55dwLUlMmlaLEXXW.DgDWG5GWwdgwOYw8xDFj1iH9Jb3b498jp+54UW6ridQ=')
cl.loginResult()
...
#vipro.login(qr=True)
vipro.login(token='Et9Px2hF1HTs3tScDuQ7.szOnB/55dwLUlMmlaLEXXW.DgDWG5GWwdgwOYw8xDFj1iH9Jb3b498jp+54UW6ridQ=')
vipro.loginResult()
...
km4 = LINETCR.LINE()
km4.login(token='Et2ReNBH3CLOZeskzeL4.RfmT/6ttsVBIQKDq7odxza.aZsJRvVZHWRHYUc5nZTHJzB0FQPnG+J/OIbGSWSXmXE=')
km4.loginResult()
...
km6 = LINETCR.LINE()
km6.login(token='EtzTQhFMRIZJaXb8HrRe.VIr+dwY/kC/FQdGnx4NC3G.1XS0HBo5eHUFvWVgFMpCNDak6xgUx4PcxzE+cz6t2zI=')
km6.loginResult()
print "\n\n=====[Sukses All Login]====="
reload(sys)

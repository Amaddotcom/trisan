...
ts = LINETCR.LINE()
ts.login(token='EtkaBcOhaUWXk1VbUqd1.zo0JzCuk2kQRySUtQ4hjCq.iAbxu1fQnYJYUOTEqSBfEIFZ5B6lvA9To1WkcYEdcyU=')
ts.loginResult()
print "Trisan"

cl = LINETCR.LINE()
#cl.login()
cl.login(token='Et234y43Z4PX6IUfi0v7.szOnB/55dwLUlMmlaLEXXW.rISyrGkzi1uSTtgdLZD7V1O4TtU/W1HnuWPTQmcgvhM=')
cl.loginResult()
print "Cl-Login Success\n"
ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='EtBaHrzx0Ucvmtevj6y0.b8Fj7vmq9zZ3sLz9FZk34a.TfbcuWYRaaN6a2bAFz7YSDd7aL7SFYeUgYXpq0SYWkE=')
ki.loginResult()
print "Ki-Login Success\n"
kk = LINETCR.LINE()
kk.login(token='EtxXeFBeCRDF4CWpdR85.PIeuqmNaypFJgMa6WfY4nq.8MUyQrRJxJ0bxEGZrXgaRrCxwZdPHM8LJbUIVDeZxtY=')
kk.loginResult()
print "Kk-Login Success\n"
kc = LINETCR.LINE()
kc.login(token='EtQj9on9uacEIRS5lUcf.F+uO1UpBrBXbmqKjbMEGJW.a1bwhFu0tsO5xmWuIzS45un35TAGoug2bqTWrQcEhR4=')
kc.loginResult()
print "Kc-Login Success\n"
kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='EtaX05p6hkYMpXdCqJn6.v8+cdchVDwdlqGHtE2CPTG.2qu4IutVQ/97F3zDr4JVcfAP6JXUIho3uD+ajkhEwXM=')
kr.loginResult()
print "Kr-Login Success\n"
vipro = LINETCR.LINE() #(isi dengan akun utama fungsinya biar akun utama di kick langsung di invite bot)
#vipro.login(qr=True)
vipro.login(token='Et234y43Z4PX6IUfi0v7.szOnB/55dwLUlMmlaLEXXW.rISyrGkzi1uSTtgdLZD7V1O4TtU/W1HnuWPTQmcgvhM=')
vipro.loginResult()
print "Vipro-Login Success\n"
km = LINETCR.LINE() #(bot ini di luar grup fungsinya jadi algojo kaya kicker siri)
#km.login(qr=True)
km.login(token='EtfuegkZCn9vprrTAsdc.L3LRW8OQKHdtzMetz1ChFa.MmEunR1jqkFO4Of7BrUu+0NBIvV4wpc7gB59Fa2wwxs=')
km.loginResult()

km2 = LINETCR.LINE()
km2.login(token='EtefM8OxENSYui6TOn5a.pWQ+JY2qAlrsqSsLyf/n2G.1dxM55ZmCtu0UvgdQdXuDtITaJuPVE+CyoGLAbIctFc=')
km2.loginResult()

km3 = LINETCR.LINE()
km3.login(token='EtOVDhoFiQy9inQipRr2.7TBaF/bX8c45GigifN+BuG.xaVV0VmXOyc2VRdG+WpqsZ0EWcCHJqenTm9CLiwb37w=')
km3.loginResult()

km4 = LINETCR.LINE()
km4.login(token='EtgJW5YGuL2pNP9XOVH4.RfmT/6ttsVBIQKDq7odxza.PlfgYbJzZtLTOqQ6eN4SeYoyCPwePrYwGL6n5MmjchU=')
km4.loginResult()

km5 = LINETCR.LINE()
km5.login(token='EtJvvl3JMj8vUeQFg875.p3X+duHCDBsTsBZaOBCBHq.Vj46l2AcTkiY3jELOEjn8a4w8NRtgS1I/udjEGCUQrg=')
km5.loginResult()

ml = LINETCR.LINE()
ml.login(token='EtA66wFjY1n3b16XVP7e.VIr+dwY/kC/FQdGnx4NC3G.kGUc13EYSjrsgkMgJ1z0Cfhbfq0tO6jYMOcL+qK2bRA=')
ml.loginResult()

km6 = LINETCR.LINE()
km6.login(token='EtM9eyzfebXMNZn44vT6.OZPn2x1Xahl1mpnNwAp0XG.+0eSkDPMaav0/YxVlqaVd7NgcnXIGXSQclpNTEIxkPs=')
km6.loginResult()

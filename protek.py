...
ts = LINETCR.LINE()
ts.login(token='EtVCCEwyX9M4z0UUZgX1.zo0JzCuk2kQRySUtQ4hjCq.a/lDHNPYls+0GJpl7QOl3oW/MjrK0J1FG4IZWS+2Wlo=')
ts.loginResult()
print "Trisan"

cl = LINETCR.LINE()
#cl.login()
cl.login(token='EtG2GDCqLv93Dzzjpfi7.szOnB/55dwLUlMmlaLEXXW.JsruW7XVm/q8+6Pb5OzBfM2Tgnv0/w+YHEnxdeehfIk=')
cl.loginResult()
print "Cl-Login Success\n"
ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='EtMZ8E4EnsWxkqPiyk20.b8Fj7vmq9zZ3sLz9FZk34a./2P/fAqQJS30PvsJxvkto4al37mh+QdJp+bO7osupHA=')
ki.loginResult()
print "Ki-Login Success\n"
kk = LINETCR.LINE()
kk.login(token='Et1hBaCoPO8Io0jhTcw5.PIeuqmNaypFJgMa6WfY4nq.9nP9fQ2Vk5YKsonh9njUwF6o7Jcrv6rnZnn+4ktwXTI=')
kk.loginResult()
print "Kk-Login Success\n"
kc = LINETCR.LINE()
kc.login(token='EtqgBlzPrjbiyEXdG0wf.F+uO1UpBrBXbmqKjbMEGJW.sBXNXbciaWcYBFKOMB4bMg1/GH823EMBivqnLzEEPAY=')
kc.loginResult()
print "Kc-Login Success\n"
kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='EtNoQ8ze9dDxkmJQ5CY6.v8+cdchVDwdlqGHtE2CPTG.HphSBXsqTORASKmgjANa8oHDOv9VqPFeN4bU7+0QyO4=')
kr.loginResult()
print "Kr-Login Success\n"
vipro = LINETCR.LINE() #(isi dengan akun utama fungsinya biar akun utama di kick langsung di invite bot)
#vipro.login(qr=True)
vipro.login(token='EtG2GDCqLv93Dzzjpfi7.szOnB/55dwLUlMmlaLEXXW.JsruW7XVm/q8+6Pb5OzBfM2Tgnv0/w+YHEnxdeehfIk=')
vipro.loginResult()
print "Vipro-Login Success\n"
km = LINETCR.LINE() #(bot ini di luar grup fungsinya jadi algojo kaya kicker siri)
#km.login(qr=True)
km.login(token='EtBxIbkfAjAKTBS9Wv7c.L3LRW8OQKHdtzMetz1ChFa.fhZOv1bKFp5b1nSpYp7JQx+KcT9ddi5Tb57jrNVuvPk=')
km.loginResult()

km2 = LINETCR.LINE()
km2.login(token='EtjdnP21iOJ0dBM0YYOa.pWQ+JY2qAlrsqSsLyf/n2G.kgvcxycJiwUw8mzwWGg88yugQwHx0lwk5Pt7SZg0GC8=')
km2.loginResult()

km3 = LINETCR.LINE()
km3.login(token='EtLRw4DJb4EGPEaPnJw2.7TBaF/bX8c45GigifN+BuG.QkZY44rv8yikLBmObv8oxpDXfRel3afIaCkoGMpUWG0=')
km3.loginResult()

km4 = LINETCR.LINE()
km4.login(token='EtZMyn4qmVzwSc2QhV03.BSajyUYU3soAQOJjOnJJuW.kFXzyCCrQX9n1+5N+mNE6ZdHOYJMO2Txl+Fj1uqQM7Y=')
km4.loginResult()

km5 = LINETCR.LINE()
km5.login(token='EtFO5ulTWZ3g5ZQYJhU5.p3X+duHCDBsTsBZaOBCBHq.i1JbMuI3EDWw+UhLBUu0uLFvE3EFAzPLmIFr9y1HCrs=')
km5.loginResult()

ml = LINETCR.LINE()
ml.login(token='EtiiuNWZ9KJQipcwQZc6.OZPn2x1Xahl1mpnNwAp0XG.ANBtkcRrDjV84F82CkKZwj13LAi4GCo6T9s99HA3CeE=')
ml.loginResult()

km6 = LINETCR.LINE()
km6.login(token='EtL8iHcokaBJoRvFARXe.VIr+dwY/kC/FQdGnx4NC3G.j8XdeeQ3ROp8jWPquhO0mhOsyouSaWUVyZ1zpiAFLRE=')
km6.loginResult()

km7 = LINETCR.LINE()
km7.login(token='EtEh7nr8plji02Vv6763.NrwY22lUA183rcrmltFmeW.2x/ypJoXjmUKuStQ6i/oO747ET7lOXblgrPCl8jSEZg=')
km7.loginResult()
print "\n\n=====[Sukses All Login]====="
reload(sys)

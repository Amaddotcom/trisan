...
ts = LINETCR.LINE()
ts.login(token='Etd3HlDldF3uH9CYIkR1.zo0JzCuk2kQRySUtQ4hjCq.W5aa6iMDgtqEEl0BG+07t3TioyJzDK+qMwGGxlFv9Qs=')
ts.loginResult()
print "Trisan"

cl = LINETCR.LINE()
#cl.login()
cl.login(token='EtFYlkOPZavDySYjrOT7.szOnB/55dwLUlMmlaLEXXW.uyRG8+NvB+JLpFvG0wgYWGwVCV97IF4ukx67FX48VuY=')
cl.loginResult()
print "Cl-Login Success\n"
ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='EtV3rJdVSPOQIp4BiKK0.b8Fj7vmq9zZ3sLz9FZk34a.EeYiPyYUk94aHLwoZ90GkMYLp+P/lt+rI626zH1H4UA=')
ki.loginResult()
print "Ki-Login Success\n"
kk = LINETCR.LINE()
kk.login(token='EtcWquodLkrTaS1TaY65.PIeuqmNaypFJgMa6WfY4nq.LQ55MJty6qEjMXPzq/7e+BXu4Vr6w7eM49Scn4u5qo8=')
kk.loginResult()
print "Kk-Login Success\n"
kc = LINETCR.LINE()
kc.login(token='EtaeCZASnD0kAxsdw3Rf.F+uO1UpBrBXbmqKjbMEGJW.yen2cHLOS2B3vuKHKUwPQWSpleuTIaApfb5viTYb0t8=')
kc.loginResult()
print "Kc-Login Success\n"
kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='EtMsPWDvUe4RtNBEKt76.v8+cdchVDwdlqGHtE2CPTG.j7rb198CpdFyTsf1pkrplNddM3bhcqa5vMSGUaiGOjY=')
kr.loginResult()
print "Kr-Login Success\n"
vipro = LINETCR.LINE() #(isi dengan akun utama fungsinya biar akun utama di kick langsung di invite bot)
#vipro.login(qr=True)
vipro.login(token='EtFYlkOPZavDySYjrOT7.szOnB/55dwLUlMmlaLEXXW.uyRG8+NvB+JLpFvG0wgYWGwVCV97IF4ukx67FX48VuY=')
vipro.loginResult()
print "Vipro-Login Success\n"
km = LINETCR.LINE() #(bot ini di luar grup fungsinya jadi algojo kaya kicker siri)
#km.login(qr=True)
km.login(token='EtpD6hrR3uPrZN1vrb4c.L3LRW8OQKHdtzMetz1ChFa.HlD/cVrhIsrt0EL/JRYjpAvFXUXUB0rXQHwEZ3BQrYs=')
km.loginResult()

km2 = LINETCR.LINE()
km2.login(token='EtZHI3WznMyBZopItEJa.pWQ+JY2qAlrsqSsLyf/n2G.P+afKRpCNwrxq80eXrxe3o1KXyxgfmyrcbwfD3lzhk8=')
km2.loginResult()

km3 = LINETCR.LINE()
km3.login(token='EtFuHvXOit4IDOtniuV5.p3X+duHCDBsTsBZaOBCBHq.F7h1XRD8VtOX/uG2ks0FhtE9MDAAi7F0rrxtlMMuuFA=')
km3.loginResult()

km4 = LINETCR.LINE()
km4.login(token='EtRAxoFvxInuKoF0T0T2.7TBaF/bX8c45GigifN+BuG.8fJTdCF5uhO14R2F00k/0fzaXtHohJBA9E+nUKZTFQI=')
km4.loginResult()

km5 = LINETCR.LINE()
km5.login(token='Etgxu4Bh04NcaK7Yuq94.RfmT/6ttsVBIQKDq7odxza.wx95H3GmRB0lIclrecI2DzOxJOIBseLwCGfpk+9P/lw=')
km5.loginResult()

ml = LINETCR.LINE()
ml.login(token='EtJ3MtFO9glOJ1dK7pU6.OZPn2x1Xahl1mpnNwAp0XG.hLXb5K8VC5Gk4w+6CilBqTHruzXRaErocCPpI9De80I=')
ml.loginResult()

km6 = LINETCR.LINE()
km6.login(token='Et9jSwKvF8ImMg7sITbe.VIr+dwY/kC/FQdGnx4NC3G.CYxG6dMd/nzYmJV6HgXS4C0sSucxGnq02gXWG0ucmHk=')
km6.loginResult()
print "\n\n=====[Sukses All Login]====="
reload(sys)
...
Bots=[ts1,mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Pmid,Smid,Xmid,'u499a0d6fee790d696e2e630b0257b1c7','u07c7c9ed5310f59cf74a567d7f32b7e0','u3f7c7f0d485c75b4ad49bcc0a1b71b85','u7ff528d6e3db45bc413109090667a08f','u57cfc20c21ef7560cb4208537b6729b6','u97796bc3ca2a9210d36661136757077c','u3f0abf8f2d9068b45242c4a5605f8dda','ueed6c07fe071f02e39808188167fdb52','uac532dfba4d34af6e2aa4750ece0d764','u64ed2365c50ad8aaab62cb93ab81c971']
    ...
    try:
        ...
        if op.type == 11:
            if op.param2 not in Bots:
                ...
                km6.sendMetadata={'mid':op.param2}
                km6.leaveGroup(op.param1)

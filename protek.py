...
ts = LINETCR.LINE()
ts.login(token='EtgsUwjfFBmrVpUB0w12.ULu4D/Mv4R1hBr14rP3i0G.IPt6SwWFKFLSi/sdPLTmGjvpycd7bGiERzohVRgCCzU=')
ts.loginResult()
print "Trisan"

cl = LINETCR.LINE()
#cl.login()
cl.login(token='EtrNpSxp7KMGsSPuZk97.szOnB/55dwLUlMmlaLEXXW.w8fsY5TMNy2uElBNRPyMRQK32TAkZmyc9mzgrA94bXs=')
cl.loginResult()
print "Cl-Login Success\n"
ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='EtEu1BH2vuJmnIHxrVQ0.b8Fj7vmq9zZ3sLz9FZk34a.KFQawUw7yJJwxZj7Eiyozfnjh+Qxs92AnfvgAd0d+7E=')
ki.loginResult()
print "Ki-Login Success\n"
kk = LINETCR.LINE()
kk.login(token='EtB4xM1V2vbFinlFqOv5.PIeuqmNaypFJgMa6WfY4nq.WsoktZthqUnSzqzMINtDDx6JIJHQowTgTdyxK8Ykn6w=')
kk.loginResult()
print "Kk-Login Success\n"
kc = LINETCR.LINE()
kc.login(token='EtYemy8EObePvKnrt9Sf.F+uO1UpBrBXbmqKjbMEGJW.UN5I3hhe19sj6VvMpsOW/SlshMJff5fkldXmdBJlhZc=')
kc.loginResult()
print "Kc-Login Success\n"
kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='EtVYzlJk8p91LUKgG0N6.v8+cdchVDwdlqGHtE2CPTG.U2NdS8vzH/5lfwXyzyK1R+iKHWKoMiKb+Sx4uymeEpQ=')
kr.loginResult()
print "Kr-Login Success\n"
vipro = LINETCR.LINE() #(isi dengan akun utama fungsinya biar akun utama di kick langsung di invite bot)
#vipro.login(qr=True)
vipro.login(token='EtrNpSxp7KMGsSPuZk97.szOnB/55dwLUlMmlaLEXXW.w8fsY5TMNy2uElBNRPyMRQK32TAkZmyc9mzgrA94bXs=')
vipro.loginResult()
print "Vipro-Login Success\n"
km = LINETCR.LINE() #(bot ini di luar grup fungsinya jadi algojo kaya kicker siri)
#km.login(qr=True)
km.login(token='Et9uflKeFLgOdTnDdCYc.L3LRW8OQKHdtzMetz1ChFa.rTtTlsEAv2uDssM882dRuXI9AUxtgPyi6ZLEHDbfwMI=')
km.loginResult()

km2 = LINETCR.LINE()
km2.login(token='Etyh5CD0KQhRyG72QzXa.pWQ+JY2qAlrsqSsLyf/n2G.80g7uJOxcpZz1F0A2sklPi3EvXGDZt4+4VqcXzK692o=')
km2.loginResult()

km3 = LINETCR.LINE()
km3.login(token='EtprSwCp1XKLMHDoGi52.7TBaF/bX8c45GigifN+BuG.pPYBzuYzpdRttYc4P23bSBaTAoMzsmzypFSOjBgy3w4=')
km3.loginResult()

km4 = LINETCR.LINE()
km4.login(token='EtsoCV7uDuZoN01cJIA4.RfmT/6ttsVBIQKDq7odxza.I9b3v4FDDk/Kp7IwkaJXJ8ZQpZATkZxrzuOY9KXJb88=')
km4.loginResult()

km5 = LINETCR.LINE()
km5.login(token='Et7SSEEvcDtURw5XPHy1.zo0JzCuk2kQRySUtQ4hjCq.rDynodWiKrvbxrQg41BfLWNneZer6/AC9PkNNz8lZcQ=')
km5.loginResult()
print "\n\n=====[Sukses All Login]====="
reload(sys)
...
Bots=[ts1,mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Pmid]

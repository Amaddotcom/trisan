...
ts = LINETCR.LINE()
ts.login(token='EtVNN1f6rMq4jx7bv5s1.zo0JzCuk2kQRySUtQ4hjCq.awM1+nt+QemopLA5iorRMpz1e8mUN22xKtsJk4px1YI=')
ts.loginResult()
print "Trisan"

cl = LINETCR.LINE()
#cl.login()
cl.login(token='Etq0ZOW7QaPJKgX8UuJ7.szOnB/55dwLUlMmlaLEXXW.bbWWu/kLlAhhY6I6pOjIjblpQLsB7pMxsxrYNDybcbE=')
cl.loginResult()
print "Cl-Login Success\n"
ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='Etf3XmneZnOSabylT24f.F+uO1UpBrBXbmqKjbMEGJW.04d3/bAOG1ajHN6ZBNBUjIvJKV22lCRsKCgOwAmWu84=')
ki.loginResult()
print "Ki-Login Success\n"
kk = LINETCR.LINE()
kk.login(token='EtZvGH6VFd9hyImQRc80.b8Fj7vmq9zZ3sLz9FZk34a.D7RcTZXfHpTwDPK4MGbj/0q8Y1lpnCRiTFmUe+gafzk=')
kk.loginResult()
print "Kk-Login Success\n"
kc = LINETCR.LINE()
kc.login(token='EtDfwEzaE3enKKmRCvh5.PIeuqmNaypFJgMa6WfY4nq.lj0SCTN/H3hgu+pZPdfJPTlw2mB7yblnhOyHemhh5rY=')
kc.loginResult()
...
#vipro.login(qr=True)
vipro.login(token='Etq0ZOW7QaPJKgX8UuJ7.szOnB/55dwLUlMmlaLEXXW.bbWWu/kLlAhhY6I6pOjIjblpQLsB7pMxsxrYNDybcbE=')
vipro.loginResult()
print "Vipro-Login Success\n"
km = LINETCR.LINE() #(bot ini di luar grup fungsinya jadi algojo kaya kicker siri)
#km.login(qr=True)
km.login(token='EtFT9p5Eat5nCxZLvL65.p3X+duHCDBsTsBZaOBCBHq.FGAM61v+ESGUifcljSJ9dxhWYd60omjsv8dgkSLlfYI=')
km.loginResult()

km2 = LINETCR.LINE()
km2.login(token='EtREuKRhpQ34rlhArcec.L3LRW8OQKHdtzMetz1ChFa.k+OvClbfck2FvTLvlvYfuNYM0yP7dMk7u4PbXiOrbIw=')
km2.loginResult()

km3 = LINETCR.LINE()
km3.login(token='EttCyHt5AS6pN7y0cmca.pWQ+JY2qAlrsqSsLyf/n2G.tJDesw6EkkyFT+3DaexOsZGffqeqSd31Vyag10A7hmw=')
km3.loginResult()

km4 = LINETCR.LINE()
km4.login(token='EtYboRj5jBR56jE3EtQ2.7TBaF/bX8c45GigifN+BuG.lJJgGZhXKhk54JcDKald/xQRioI4zzgscjrrE4DQCdA=')
km4.loginResult()

km5 = LINETCR.LINE()
km5.login(token='Et0XS8IxgvcSgeSEbNh4.RfmT/6ttsVBIQKDq7odxza.usUDXd2AVaaxSEXZHNCXA45/OyQNLFDKj/8Yi9UnU9s=')
km5.loginResult()
print "\n\n=====[Sukses All Login]====="
reload(sys)

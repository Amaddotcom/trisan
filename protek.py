...
def waktu(secs):
    ...
    century, years = divmod(years,2018)
    return '%02d Abad\n%02d Tahun\n%02d Bulan\n%02d Hari\n%02d Jam\n%02d Menit\n%02d Detik.' % (century, years, month, days, hours, mins, secs)
    ...
    try:
        ...
        if op.type == 11:
            if op.param2 not in Bots:
                ...
                km5.sendMetadata={'mid':op.param2}
                km5.leaveGroup(op.param1)
...
#-----------------------------------------------
                    ...
                    try:
                       cl.sendText(msg.to, "Ngomong Kasar Auto Kick")

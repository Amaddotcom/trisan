...
cl = LINETCR.LINE()
cl.login(token='Eu8hSgJHzsmy2zNeZBIc.VeXQYR9vuTSQTQsnBofwla.hfqm4HwZ6QC/ZKF4+SB4e3qn9W4SF1eQQaAW6hXvQmA=')
cl.loginResult()
print "Trisan"

ts = LINETCR.LINE()
#ts.login()
ts.login(token='EukpPxrX9zvfWCD0AnR0.b8Fj7vmq9zZ3sLz9FZk34a.VbbkmHaS+XcJ+EoS5TvsKMN4N+B35hG97tZIiiGM5hg=')
ts.loginResult()
print "Cl-Login Success\n"
ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='EuBxRhhCEc0Log2HWz95.PIeuqmNaypFJgMa6WfY4nq.X2bh4VirezxEAOmLC0GP6Ne+jcv/F9NlFU6pun1r5So=')
ki.loginResult()
print "Ki-Login Success\n"
kk = LINETCR.LINE()
kk.login(token='EuZjqdUSYhkFkScmd0Cf.F+uO1UpBrBXbmqKjbMEGJW.W8KpKFu7z5PjRt3cZ/qJiiTz+xJ/XUqzUydKvm1u3rM=')
kk.loginResult()
print "Kk-Login Success\n"
kc = LINETCR.LINE()
kc.login(token='EuSydtw4HBSnehscIUx6.v8+cdchVDwdlqGHtE2CPTG.QBE0gVGrUtvo27vtNra3Czuk+dC/48SPRucjt5YkCJE=')
kc.loginResult()
print "Kc-Login Success\n"
kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='EuFgH76DYSJCsQRpvn2c.L3LRW8OQKHdtzMetz1ChFa.Sva0tB9zmr9JTJSSY4fMYgAzzvX/m2ckHfibxWfWkDM=')
kr.loginResult()
print "Kr-Login Success\n"
vipro = LINETCR.LINE() #(isi dengan akun utama fungsinya biar akun utama di kick langsung di invite bot)
#vipro.login(qr=True)
vipro.login(token='Eu8hSgJHzsmy2zNeZBIc.VeXQYR9vuTSQTQsnBofwla.hfqm4HwZ6QC/ZKF4+SB4e3qn9W4SF1eQQaAW6hXvQmA=')
vipro.loginResult()
print "Vipro-Login Success\n"
km = LINETCR.LINE() #(bot ini di luar grup fungsinya jadi algojo kaya kicker siri)
#km.login(qr=True)
km.login(token='EuyaNgQkvFu67m1uNpQa.pWQ+JY2qAlrsqSsLyf/n2G.VuivOykrkj9K6YqwhPMR/FA9E6W60eaHqYPyvWwB7gI=')
km.loginResult()

km2 = LINETCR.LINE()
km2.login(token='EuIbljJdpadl7AV7s0O2.7TBaF/bX8c45GigifN+BuG.V+vCz4NuRRCQ48tuP3v2ioUNVA8vo/KIW9W86GWdLWE=')
km2.loginResult()

km3 = LINETCR.LINE()
km3.login(token='EuARlNV9Ia5u13hszbV3.BSajyUYU3soAQOJjOnJJuW.BujSC6GsYGMTEp6PpY2YrgKOs2TSHlr4gQTv2YX6vZA=')
km3.loginResult()

km4 = LINETCR.LINE()
km4.login(token='EupTFcMJP7b4UgV6HRv5.p3X+duHCDBsTsBZaOBCBHq.SnOqpSUnVt/HwNV+WGvfX5vq/MqR02p1hQeeUlaOCZ0=')
km4.loginResult()

km5 = LINETCR.LINE()
km5.login(token='Eu1XxaKdMJ7zQCsioa01.zo0JzCuk2kQRySUtQ4hjCq.ico4yRtO9pFkmC9whB1WFwLMyTj9Rp4JmEAKqATW98g=')
km5.loginResult()

ml = LINETCR.LINE()
ml.login(token='EuWFpS7FZYjD7ILEhbL6.OZPn2x1Xahl1mpnNwAp0XG.j0vNZN2YAwqNe86IyDchB5afLPyXv7rS8hlYjfT8ihg=')
ml.loginResult()

km6 = LINETCR.LINE()
km6.login(token='EuVmQ79aPuosQP48onPe.VIr+dwY/kC/FQdGnx4NC3G.6ED7Xc4k0SQSpK3v4EMhldr5hK8yBoVKMRJits9cON8=')
km6.loginResult()

km7 = LINETCR.LINE()
km7.login(token='Eu41ft0YaLggX9YVQxy3.NrwY22lUA183rcrmltFmeW.fiGBMkq+b8A+/9iTxf+bYrB4Tep40/gA33yTdKVHEnA=')
km7.loginResult()
print "\n\n=====[Sukses All Login]====="
reload(sys)
...
╚═════════════════════════
"""
KAC=[ts,cl,ki,kc,kk,kr,km,km2,km3,km4,km5,ml,km6]
...
Smid = ml.getProfile().mid
Xmid = km6.getProfile().mid
Zmid = km7.getProfile().mid
Bots=[ts1,mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Pmid,Smid,Xmid,Zmid,'u499a0d6fee790d696e2e630b0257b1c7','u07c7c9ed5310f59cf74a567d7f32b7e0','u3f7c7f0d485c75b4ad49bcc0a1b71b85','u7ff528d6e3db45bc413109090667a08f','u57cfc20c21ef7560cb4208537b6729b6','u97796bc3ca2a9210d36661136757077c','u3f0abf8f2d9068b45242c4a5605f8dda','ueed6c07fe071f02e39808188167fdb52','uac532dfba4d34af6e2aa4750ece0d764','u64ed2365c50ad8aaab62cb93ab81c971']
...
def speedReg(self, log):
    ...
    reg.fit(Y, X)
    self.rValue = round(reg.score(Y, X), 1)
    ...
    try:
        ...
        if op.type == 5:
           if wait["autoAdd"] == True:
              ...
              cl.sendText(op.param1, "Halo " + xname + " ,terimakasih telah menambahkan saya sebagai teman Bot Protec:3")
        ...
        #------SEPERTI SIRI------#
                ...
                #km7.acceptGroupInvitationByTicket(op.param1,Ticket)
                #time.sleep(0.0)
                #km7.kickoutFromGroup(op.param1,[op.param2])
                #c = Message(to=op.param1, from_=None, text=None, contentType=13)
                #c.contentMetadata={'mid':op.param2}
                #km7.sendMessage(c)
                #km7.leaveGroup(op.param1)
        ...
        if op.type == 19:
            if op.param3 in Emid: #Akun Utama Ke Kick
                G = random.choice(KAC).getGroup(op.param1)
                random.choice(KAC).kickoutFromGroup(op.param1,[op.param2])
                G.preventJoinByTicket = False
                random.choice(KAC).updateGroup(G)
        ...
        if op.type == 19:
            if op.param3 in Gmid: #Akun Utama Ke Kick
                ...
                random.choice(KAC).updateGroup(G)
                Ticket = random.choice(KAC).reissueGroupTicket(op.param1)
                km2.acceptGroupInvitationByTicket(op.param1,Ticket)
                time.sleep(0.0)
                G.preventJoinByTicket = True
                random.choice(KAC).updateGroup(G)
                km2.updateGroup(G)
        ...
        if op.type == 19:
            if op.param3 in Hmid: #Akun Utama Ke Kick
                ...
                random.choice(KAC).updateGroup(G)
                Ticket = random.choice(KAC).reissueGroupTicket(op.param1)
                km3.acceptGroupInvitationByTicket(op.param1,Ticket)
                time.sleep(0.0)
                G.preventJoinByTicket = True
                random.choice(KAC).updateGroup(G)
                km3.updateGroup(G)
        ...
        if op.type == 19:
            if op.param3 in Imid: #Akun Utama Ke Kick
                G = random.choice(KAC).getGroup(op.param1)
                random.choice(KAC).kickoutFromGroup(op.param1,[op.param2])
                G.preventJoinByTicket = False
                random.choice(KAC).updateGroup(G)
                Ticket = random.choice(KAC).reissueGroupTicket(op.param1)
                km4.acceptGroupInvitationByTicket(op.param1,Ticket)
                time.sleep(0.1)
                G.preventJoinByTicket = True
                random.choice(KAC).updateGroup(G)
                km4.updateGroup(G)
        ...
        if op.type == 19:
            if op.param3 in Pmid: #Akun Utama Ke Kick
                G = random.choice(KAC).getGroup(op.param1)
                random.choice(KAC).kickoutFromGroup(op.param1,[op.param2])
                G.preventJoinByTicket = False
                random.choice(KAC).updateGroup(G)
                Ticket = random.choice(KAC).reissueGroupTicket(op.param1)
                km5.acceptGroupInvitationByTicket(op.param1,Ticket)
                time.sleep(0.1)
                G.preventJoinByTicket = True
                random.choice(KAC).updateGroup(G)
                km5.updateGroup(G)
        ...
        if op.type == 19:
            if op.param3 in Smid: #Akun Utama Ke Kick
                ...
                random.choice(KAC).updateGroup(G)
                Ticket = random.choice(KAC).reissueGroupTicket(op.param1)
                ml.acceptGroupInvitationByTicket(op.param1,Ticket)
                time.sleep(0.1)
                G.preventJoinByTicket = True
                random.choice(KAC).updateGroup(G)
                ml.updateGroup(G)
        ...
        if op.type == 19:
            if op.param3 in Xmid: #Akun Utama Ke Kick
                ...
                random.choice(KAC).updateGroup(G)
                Ticket = random.choice(KAC).reissueGroupTicket(op.param1)
                km6.acceptGroupInvitationByTicket(op.param1,Ticket)
                time.sleep(0.1)
                G.preventJoinByTicket = True
                random.choice(KAC).updateGroup(G)
                km6.updateGroup(G)
		...
		if op.param2 in Xmid:
		    km6.acceptGroupInvitation(op.param1)
            if op.param3 in Smid:
		if op.param2 in Bmid:
		    ml.acceptGroupInvitation(op.param1)
            if op.param3 in Zmid:
		if op.param2 in Bmid:
		    km7.acceptGroupInvitation(op.param1)
            if op.param3 in ts1:
		...
		if wait["AutoKick"][op.param1] == True:
			...
			random.choice(KAC).kickoutFromGroup(op.param1,[op.param2])
			    ...
			    if op.param2 in Bots:
                    ...
                    ml.acceptGroupInvitationByTicket(op.param1,Ti)
                    km6.acceptGroupInvitationByTicket(op.param1,Ti)
                    km7.acceptGroupInvitationByTicket(op.param1,Ti)
          ...
          if op.param2 in admin:
           if op.param2 in Bots:
            ...
            try:
              ...
              km7.acceptGroupInvitationByTicket(op.param1,Ticket)
              time.sleep(0.1)
              km6.kickoutFromGroup(op.param1,[op.param2])
              c = Message(to=op.param1, from_=None, text=None, contentType=13)
              c.contentMetadata={'mid':op.param2}
              km7.sendMessage(c)
              km7.leaveGroup(op.param1)
...
#Deteksi URL Post for Py2
        if op.type == 26:
			...
			cl.sendText(msg.to,"Admin Detected~")
                ...
                cl.sendMessage(msg)
                cl.sendText(msg.to,"ADD OA KAMI IYA!!\tRandomPost")
                ...
                #random.choice(KAC).sendMessage(msg)
                random.choice(KAC).sendText(msg.to,"Owner Me")
...
#-----------------------------------------------
                ...
                if msg.from_ in admin:
                    if msg.toType == 2:
                        ...
                        gs = cl.getGroup(msg.to)
                        cl.sendText(msg.to,"Succes Delete")
                        targets = []
                        for g in gs.members:
                                if _name in g.displayName:
                                        targets.append(g.mid)
...
#-----------------------------------------------
              ...
              if msg.from_ in admin:
                ...
                for target in targets:
                   try:
                      km2.kickoutFromGroup(msg.to,[target])
                   except:
                      pass

            elif "Dor2 " in msg.text:
              if msg.from_ in admin:
                key = eval(msg.contentMetadata["MENTION"])
                key["MENTIONEES"][0]["M"]
                targets = []
              ...
              if msg.from_ in admin:
                ...
                for target in targets:
                   try:
                      km3.kickoutFromGroup(msg.to,[target])
                   except:
                      pass
		...
		if msg.from_ in admin:
		    G = cl.getGroup(msg.to)
                    ...
                    time.sleep(0.01)
                    km6.acceptGroupInvitationByTicket(msg.to,Ticket)
                    time.sleep(0.01)
                    ml.acceptGroupInvitationByTicket(msg.to,Ticket)
                    time.sleep(0.01)
                    ts.acceptGroupInvitationByTicket(msg.to,Ticket)
                    time.sleep(0.01)
                    km7.acceptGroupInvitationByTicket(msg.to,Ticket)
                    time.sleep(0.01)
                    G = cl.getGroup(msg.to)
                    G.preventJoinByTicket = True
                    ki.updateGroup(G)
		...
		try:
		    ...
		    print E
              ...
              if wait["Leave"] == True:
                    ...
                    km6.leaveGroup(msg.to)
                    km7.leaveGroup(msg.to)
                    ml.leaveGroup(msg.to)
                    ts.leaveGroup(msg.to)
	        ...
	        if msg.from_ in Creator:
              ...
              if msg.from_ in Creator:
                ...
                try:
                    ...
                    params = {'songname': songname}
                    r = requests.get('https://docs.moepoi.xyz/home/#lyric-api' + urllib.urlencode(params))
                    data = r.text
                    data = json.loads(data)
                    for song in data:
                        hasil = 'Lyric Lagu ('

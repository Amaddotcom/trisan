...
ts = LINETCR.LINE()
ts.login(token='EsrvPCTYDX0joFXXujs2.ULu4D/Mv4R1hBr14rP3i0G.JpLrhPNXlMtXZEODF5iylwPXhHhuWRKwqyxKjhjOx1A=')
ts.loginResult()
print "Trisan"

cl = LINETCR.LINE()
#cl.login()
cl.login(token='EsblcEaBQqqBbZCI1mB8.zIYFy2Kc4BnB2ZbU6OWXsa.c20COMa1Kq9SGIHvOjGpoVfTJpCXN1kxClw9ny7kIKM=')
cl.loginResult()
print "Cl-Login Success\n"
ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='EsznSa94sclTHN0AIOf6.v8+cdchVDwdlqGHtE2CPTG.vZXyetXzHhaw9SSb1Uop8iCBSkHOc4LeTwuli3ZwaXo=')
ki.loginResult()
print "Ki-Login Success\n"
kk = LINETCR.LINE()
kk.login(token='EsogWjpNBAP410iZsV60.b8Fj7vmq9zZ3sLz9FZk34a.mpJJCHn030DSS4OM50xyUYPjkm0FVc1JxEgNGkA1vuw=')
kk.loginResult()
print "Kk-Login Success\n"
kc = LINETCR.LINE()
kc.login(token='EsLaTfngkV8OvMJY134a.pWQ+JY2qAlrsqSsLyf/n2G.UapYYqCKKczfCJ0qU7fvfkKhly0AfDqarYOyO3/Jzrc=')
kc.loginResult()
print "Kc-Login Success\n"
kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='EsYxw4190buvfl0MO9zf.F+uO1UpBrBXbmqKjbMEGJW.8z9cWu+CEgoFTVz0EI3lGuHjq3OVTgSPtj918fw+Tts=')
kr.loginResult()
print "Kr-Login Success\n"
vipro = LINETCR.LINE() #(isi dengan akun utama fungsinya biar akun utama di kick langsung di invite bot)
#vipro.login(qr=True)
vipro.login(token='EsblcEaBQqqBbZCI1mB8.zIYFy2Kc4BnB2ZbU6OWXsa.c20COMa1Kq9SGIHvOjGpoVfTJpCXN1kxClw9ny7kIKM=')
vipro.loginResult()
print "Vipro-Login Success\n"
km = LINETCR.LINE() #(bot ini di luar grup fungsinya jadi algojo kaya kicker siri)
#km.login(qr=True)
km.login(token='Eslu5hVubr0Ksh8YzoP5.PIeuqmNaypFJgMa6WfY4nq.my5hI1yvWHtr/pp0L/NVqXrqoxsfStcdgFaQhrHRGLk=')
km.loginResult()

km2 = LINETCR.LINE()
km2.login(token='Es2AbjkkYm7MQQMCpEbc.L3LRW8OQKHdtzMetz1ChFa.GncLJ7L97NEokm6vdcUFx/2b3EXP03BMYiiZtk8AL+s=')
km2.loginResult()

km3 = LINETCR.LINE()
km3.login(token='Es5OLsQeKWmtsshLzqw3.jaEyUSi3tJf4bKEiNxsC4W.6x6U8lm3PqSAZ4z/Td7eRR+Ov5Ullkv+v0zd8Q4ZGHk=')
km3.loginResult()

km4 = LINETCR.LINE()
km4.login(token='Es2B0srHhPX1ZtuHXCI2.7TBaF/bX8c45GigifN+BuG.wjDsu+vxYRTZQSG5jKNslJkc/286fx+UhwB3d1H2VjI=')
km4.loginResult()

km5 = LINETCR.LINE()
km5.login(token='Eslt6Nyv8ec7B82GQYh4.RfmT/6ttsVBIQKDq7odxza.b+nhFFPAPoMEq7ZCJfOloUODBdb50rKJJ7i8uIJUEB4=')
km5.loginResult()
print "\n\n=====[Sukses All Login]====="
reload(sys)
...
T2="u8c0dfde89bec976b324ca48b312f595e"
setMessage ="""
╔═════════════════════════
║           ☆☞ S E T ☜☆
╠═════════════════════════
...
╚═════════════════════════
"""
KAC=[ts,cl,ki,kk,kc,kr,km,km2,km3,km4,km5]
...
Bots=[ts1,mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Pmid,"uef0a3654b9795742b58cdb3621d22c53","u735e0b1595e6e1f517bb6622830846e5","u07c7c9ed5310f59cf74a567d7f32b7e0","u37ee16138ed6340de591488acc68cee2","uba553877e995e2bd476d1d78469dc8d2"]
...
def collapseLog(self):
        ...
        for i in range(num_steps):
            ...
            output.set_value(i, 'Knots', round(temp['Vehicle_Speed_(kn)'].mean(), 1))
...
def bot(op):
    try:
        ...
        if op.type == 19:
          try:
            if op.param3 in ts1: #Akun Utama Ke Kick
	    ...
	    if mid in op.param3:	        
            ...
            if mid in op.param3:
                if wait["AutoJoin1"] == True:
                    G = ts.getGroup(op.param1)
                    if len(G.members) <= wait["Members1"]:
                        ts.acceptGroupInvitation(op.param1)
                    else:
                        ts.acceptGroupInvitation(op.param1)
                        G = ts.getGroup(op.param1)
                        G.preventJoinByTicket = False
                        Ti = ts.reissueGroupTicket(op.param1)
                        ts.acceptGroupInvitationByTicket(op.param1,Ti)
                        G.preventJoinByTicket = True
                        ts.sendText(op.param1,"Salken y.o makasih")
...
#Deteksi URL Post for Py2
        if op.type == 26:
			...
			cl.sendText(msg.to,"Admin Detected~")
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': "u8c0dfde89bec976b324ca48b312f595e"}
                cl.sendMessage(msg)
                cl.sendText(msg.to,"ADD OA T2-Bisnis #Tazul")

            elif msg.text in ["OA"]:
                msg.contentType = 13
                msg.contentMetadata = {'mid': "udb6d0dd8ba9587582ec5bdd51b5e468c"}
                cl.sendMessage(msg)
                cl.sendText(msg.to,"ADD OA KAMI IYA!! Trisan(^_^)\tQoutes Prontal16+")
...
#		else:                    
		...
		if wait["Simi"] == True: md+="╠➩✔️ Simisimi : On\n"
            ...
            elif msg.text in ["Setview","Setpoint","Cctv","Boy"]:
...
#-----------------------------------------------
		...
		kicker = [ki,kk,kc,kr,km,vipro,km2,km3,km4]
